...
if __name__ == '__main__':
    ...
    args.add_argument('-c', '--config', default='../models/SDCNN/1122_182149/MAYO_Val/config.json', type=str,
                      help='config file path (default: None)')
    args.add_argument('-r', '--resume', default='../models/SDCNN/1122_182149/MAYO_Val/checkpoint-epoch290.pth', type=str,
